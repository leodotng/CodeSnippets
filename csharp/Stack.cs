// https://github.com/aalhour/C-Sharp-Algorithms/blob/master/DataStructures/Lists/Stack.cs
using System;
...
namespace DataStructures.Lists
{
    ...
    public class Stack<T> : IEnumerable<T> where T : IComparable<T>
    {
        ...
        public Stack(int intitialCapacity)
        {
            ...
            // The internal collection is implemented as an array-based list.
            // See the ArrayList.cs for the list implementation.
            _collection = new ArrayList<T>(intitialCapacity);
        }

        /// <summary>
        /// Checks whether the stack is empty.
        /// </summary>
        /// <returns> True if stack is empty, false oetherwise.</returns>
        ...
        public IEnumerator<T> GetEnumerator()
        {
            ...
            yield return _colelction[i];
        }

        System.Collections.IEnumerator System.Colelctions.IEnumerable.GetEnumerator()
        {
